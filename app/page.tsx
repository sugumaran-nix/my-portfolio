        ...
        <section id="contact" className="section-divider section-muted px-6 py-20 md:px-10 md:py-28">
          <div className="mx-auto max-w-[1100px]">
            <Reveal className="mb-2">
              ...
              <p className="mt-3 max-w-[440px] text-[16px] leading-[1.8] text-inkMuted dark:text-white/65">Open to AI/ML and full-stack roles, internships, and thoughtful collaborations. I read everything.</p>
            </Reveal>
